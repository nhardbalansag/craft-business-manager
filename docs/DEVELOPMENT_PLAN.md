...
Status: **TP5G COMPLETE / TP6A NEXT**
...
TP6 — Pricing UI                                                  NOT STARTED
    ...
    TP6B — Create / Edit / Archive Tier Form                      NOT STARTED
...
TP5G is complete. Do not start TP6A automatically from the TP5G completion gate.
