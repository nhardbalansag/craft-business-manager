...
2.2 — Yield Evidence & Per-Good-Piece Learning        IN PROGRESS
    ...
    2.2C — Effective Yield Selection & History        VALIDATION / MERGE GATE
...
- dedicated Product contract and category rules.

### 2.1B — Mix Preset Contract & Ratio Engine
- reusable mix contract and deterministic ratio resolution.

### 2.1C — Product / Mix Repositories & Application Services
- storage-agnostic repositories/services with relationship validation.
...
- historical learning works with archived material records when identity/calibration evidence remains available.
...
Implementation is complete on `feature/phase-2-2c-yield-history` and is awaiting CI / merge validation.
